...
##STEP 5: Click "Clear Files List", then drag in Rate_Constant_mesh3d to see a 3D surface plot
##STEP 6: Click "Clear Files List", then drag in Rate_Constant_scatter3d to see a 3D scatter plot
##STEP 7: Click "Clear Files List", then drag in LaMnO3.json and LaFeO3.json
##STEP 8: Click "End", this will return the merged record of the final plot.

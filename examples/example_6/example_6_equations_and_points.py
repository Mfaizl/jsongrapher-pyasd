...
example_record = JSONGrapher.merge_JSONGrapherRecords(["O_OH_100.json","O_OH_100_relation.json","O_OH_110.json","O_OH_110_relation.json" ])
example_record.plot_with_plotly()